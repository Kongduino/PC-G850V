...
2850 LOCATE 0, 5: PRINT SB$(0)
2855 LOCATE 6, 2: PRINT SU$(0)
2860 PRINT #1, E$ + D$(0) + " | "+ SU$(0)
2865 PRINT #1, "      " + SB$(0)
2870 B = A: GOSUB "MKADR0"
2880 LOCATE 0, 4: PRINT "Next address is 0x" + AD$
...
3570 ENDIF
3580 LOCATE 0, 4
3590 PRINT "GRP: DD = " + STR$(DD) + ": K = " + STR$(K) + " ==> " + RR$
3600*GRP0: NK$ = INKEY$
3610 IF NK$ = "" THEN "GRP0"
3620 RETURN
...
3720 ENDIF
3730 LOCATE 0, 4
3740 PRINT "GRP2: DD = " + STR$(DD) + ": K = " + STR$(K) + " ==> " + RR$
3750*GRP20: NK$ = INKEY$
3760 IF NK$ = "" THEN "GRP20"
3770 RETURN
...
4096 ENDIF
4092 IF B = &HBFF1 THEN
4094 AD$ ="DSPDE": RETURN
4096 ENDIF
4098 IF B = &HBD03 THEN
4100 AD$ ="REGOUT": RETURN
4102 ENDIF
